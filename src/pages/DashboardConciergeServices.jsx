...
const DashboardConciergeServices = () => {
  const [services, setServices] = useState([]);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(null);
  const user = authService.user || authService.getCurrentUser();
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-8 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h2 className="text-2xl font-bold text-[#ff385c]">Manage Concierge Services</h2>
          <p className="text-gray-500 mt-1">Add, edit, or delete your concierge service offerings</p>
        </div>
        <button
...
export default DashboardConciergeServices; 